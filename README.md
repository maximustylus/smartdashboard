...
|---|---|---|
| Application version | `IMPLEMENTED` — **v2.16.0** | `package.json` is the version source; `src/version.js` supplies the label rendered in the app. |
...
The deployed application reports **v2.16.0**, which lets a team lead change one duty on one
...
[`CHANGELOG.md`](CHANGELOG.md) is the authoritative release history. The current version is **v2.16.0**.
