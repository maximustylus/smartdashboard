...
export const DICTIONARY = {
  ...
  ms: {
    ...
    reflections: [
      ...
      () => 'Saya telah merekodkan tempoh sesi anda. ',
      ...
      (input) => /(ya|yes)/i.test(input) ? 'Terima kasih kerana berkongsi. Ini akan diambil kira dalam rancangan anda. ' : 'Baik, saya telah merekodkannya. ',
      () => 'Kesejahteraan mental anda sama pentingnya dengan kesihatan fizikal. ',
      () => 'Saya telah merekodkannya. ',
      () => 'Terima kasih kerana berkongsi. ',
      () => 'Baik, ini membantu kami mencari ruang komuniti berdekatan. ',
      () => 'Saya sedang mencari sumber berdekatan. ',
      (input) => /(tidak|tiada|no)/i.test(input) ? 'Baik, saya akan mulakan rekod baharu. ' : 'Saya akan menghubungkan rekod lama anda. ',
